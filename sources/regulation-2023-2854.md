...
**Verbatim source.** Full text of every recital and every article of Regulation (EU) 2023/2854 of the European Parliament and of the Council of 13 December 2023 on harmonised rules on fair access to and use of data and amending Regulation (EU) 2017/2394 and Directive (EU) 2020/1828 (Data Act).

## Provenance

| Field | Value |
|-------|-------|
| Short title | Data Act |
| CELEX | 32023R2854 |
| ELI | http://data.europa.eu/eli/reg/2023/2854/oj |
| OJ reference | OJ L, 2023/2854, 22.12.2023 |
| Adopted | 13 December 2023 |
| Entry into force | 11 January 2024 |
| General application | 12 September 2025 (Article 50) |
| Fetched from | https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32023R2854 |
| Fetch date | 2026-05-15 |

## Conventions used in this file

- Each recital appears under `## Recital N` with the body as a blockquote.
- Each article appears under `## Article N` with the article title in bold, followed by `### Article N(M)` headings for numbered paragraphs.
- Lettered points within paragraphs (a), (b), (c) appear as markdown bullet lists. Sub-points (i), (ii), (iii) are nested.
- OJ footnote reference numbers have been stripped from the body text for clarity. The substantive cross-references (for example to Regulation (EU) 2016/679) appear in full in the body and are unaffected. To see the original footnote markers, consult the EUR-Lex source above.
- The text is verbatim aside from the footnote markers noted above. Skill outputs must quote from this file rather than paraphrase from training data. If a needed Article or Recital is missing or malformed, that is a coverage defect: stop and report it.
...
### Article 12(1)
This Chapter shall apply where, in business-to-business relations, a data holder is obliged under Article 5 or under applicable Union law or national legislation adopted in accordance with Union law, to make data available to a data recipient.

### Article 12(2)
A contractual term in a data sharing agreement which, to the detriment of one party, or, where applicable, to the detriment of the user, excludes the application of this Chapter, derogates from it, or varies its effect, shall not be binding on that party.
...
### Article 20(3)
Paragraph 2 shall also apply where a microenterprise and small enterprise claims compensation for making data available.
...
**End of Regulation (EU) 2023/2854.**
